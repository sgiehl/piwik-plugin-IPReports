...
describe("IPReports", function () {
    ...
    it('show ip report', async function () {
    ...
    it('show ip type report', async function () {
        expect(await page.screenshotSelector('#widgetIPReportsgetIPTypes')).to.matchImage('type_report');
    });
});
